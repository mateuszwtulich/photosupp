...
const BOOKING: BookingEto = {id: 1, name: "Booking #1", description: "short descriptionssss sssssssssssssss ssssssssss sssssssss ssssssss sssssss sssss ssss", service: SERVICE, address: ADDRESS, user: USER, isConfirmed: true, predictedPrice: 1000, start: "22-11-2020", end: "20-11-2020", modificationDate: "22-11-2020", priceIndicatorList: PRICE_INDICATORS};
